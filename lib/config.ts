...
export const hero: EventStates = {
	...
	duringEvent: "NMMUN 2026 has started, we wish you all the very best!",
	afterEvent:
		"NMMUN 2026 is over. Thank you for joining us and we hope to see you next year!",
};
...
export const eventDate = "2026-09-18 08:00:00"; // YYYY-MM-DD HH-MM-SS
export const eventEndDate = "2026-09-19 18:00:00"; //! must always be after the event
export const eventDateInWords = "18th & 19th September, 2026";
